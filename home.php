...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="validatehome.php" method="post">
...
<center><span class="forget-password"><center><a href="reg.php">Not Yet Signed In?</a></span></center> 
</center>    
</div>
...
window.onclick = function(event) {
    if (event.target == modal) {
        modal.style.display = "none";
			...
			<li><a href="reg.php" class="signup">Sign Up</a></li>
			</ul>			
		</div>
